...
export const DUPLER_STEPS: DemoStep[] = [
    ...
    },
    {
        ...
        description: 'AI Mapping Agent structures extracted data into SPEC/PMX format. 5 of 8 items auto-mapped at 97%+ confidence. 3 items flagged for designer review — quantity ambiguity, finish/color verification, and material grade.',
        app: 'dupler-pdf',
        role: 'Designer',
    },
    {
