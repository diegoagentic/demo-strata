...
function getStepDataThread(stepId: string): string | null {
    const threads: Record<string, string> = {
        ...
        'd2.1': 'Columbus 72% — Wall of Shame: 3 aging, 2 allocation conflicts resolved',
        'd2.2': '28/30 matched — 26 pristine, 2 exceptions',
        'd2.3': '5 items verified — 2 margin alerts, tax auto-applied',
        'd2.4': '3 warehouses synced — dock resolved, $1,200 saved',
        'd2.5': '5 shipments tracked — 1 delay predicted, $340 freight claim filed',
        'd2.6': '3 claims processed — $2,770 credits',
        'd2.7': 'Sarah Chen approved — dispatch confirmed Thu 8AM',
        'd3.1': '5 systems bridged — 1,840 items synced, health 78/100',
        'd3.2': '97.2% stock accuracy — 3 discrepancies fixed',
        'd3.3': 'Report assembled — 3 push alerts queued (Teams, Email, SMS)',
