...
function getStepDataThread(stepId: string): string | null {
    const threads: Record<string, string> = {
        ...
        // Dupler
        'd1.1': '54 items extracted from catalog — 50 fully mapped, 4 need review',
        'd1.2': '4 items reviewed — 2 resolved by AI, 2 by Expert Hub specialist',
        'd1.3': '5 items verified — 2 upcharges acknowledged ($1,470)',
        'd1.4': 'SPEC-MH-0412 assembled — sent to Randy Martinez (SC)',
        'd1.5': '38% discount applied — priced specification ready',
        'd2.1': 'Columbus 72% — 3 aging items, 2 conflicts resolved',
        'd2.2': '28/30 matched — 2 exceptions resolved',
        'd2.3': '15 items verified — 2 margin alerts resolved',
        'd2.4': '3 warehouses synced — routes optimized, $1,200 saved',
        'd2.5': '5 shipments tracked — delay predicted, $340 overcharge filed',
