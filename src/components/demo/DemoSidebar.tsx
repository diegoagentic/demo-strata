...
function getStepDataThread(stepId: string): string | null {
    const threads: Record<string, string> = {
        ...
        // Dupler
        'd1.1': '8 items extracted from vendor quote — 2 flagged for review',
        'd1.2': '5 auto-confirmed, 3 reviewed by designer — all mapped',
        'd1.3': '$1,380 in upcharges — all prices verified',
        'd1.4': '31/32 match drawings — spec package sent to SC',
        'd1.5': 'Discounts applied — final pricing exported',
