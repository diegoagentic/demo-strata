                ...
                <div className="md:col-span-3 p-4">
                    ...
                    <div className="space-y-1.5">
                        {sif.lineItems.slice(0, extractedCount).map((item, i) => (
                            <div
                                key={i}
                                className="flex items-center gap-2 bg-background border border-border rounded-lg px-3 py-2 text-xs animate-in fade-in slide-in-from-left-2 duration-300"
                            >
                        ...
                        {Array.from({ length: Math.max(0, sif.lineItems.length - extractedCount) }).map((_, i) => (
                            <div
                                key={`ph-${i}`}
                                className="flex items-center gap-2 bg-muted/30 border border-dashed border-border/50 rounded-lg px-3 py-2 text-xs opacity-50"
                            >
